...
const SingleScamRequest = React.lazy(() => import("./pages/singlescamrequest/singlescamrequest"));
const ScamRequests = React.lazy(() => import("./pages/scamrequests/scamrequests"));
const LoginComponent = React.lazy(() => import("./components/login/login"));
const HomePage = React.lazy(() => import("./pages/homepage/homepage"));
const AllScammerPage = React.lazy(() => import("./pages/allscammerpage/allscammerpage"));
const NewestScamsPage = React.lazy(() => import("./pages/newestscamspage/newestscamspage"));
const TopScamPage = React.lazy(() => import("./pages/topscampage/topscampage"));
const ReportScamPage = React.lazy(() => import("./pages/reportscampage/reportscampage"));
const VerificationPage = React.lazy(() => import("./pages/verificationpage/verificationpage"));
const SingleScamDetailsPage = React.lazy(() => import("./pages/singlescamdetailspage/singlescamdetailspage"));
const SignUpComponent = React.lazy(() => import("./components/signup/signup"));
const PostNewScamPage = React.lazy(() => import("./pages/postnewscampage/postnewscampage"));
